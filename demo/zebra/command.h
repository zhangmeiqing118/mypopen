...
#define DEFUN(funcname, cmdname, cmdstr, helpstr) \
  ...
  { \
    cmdstr, \
    funcname, \
    helpstr, 0, NULL, 0, NULL, NULL \
  }; \
  int funcname \
  (__attribute__((unused))struct cmd_element *self, __attribute__((unused))struct vty *vty, __attribute__((unused))int argc, __attribute__((unused))char **argv)

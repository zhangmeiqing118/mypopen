...
/* Settings */
    ...
    #define ME_GOAHEAD_LIMIT_POST 0x4000000/*rjt 2015-5-11*/
#endif
    ...
    #define ME_GOAHEAD_LISTEN "https://*:443"//"http://*:80,https://*:443"
#endif
    ...
    #define ME_GOAHEAD_UPLOAD_DIR "/mnt/ramdisk"/*add path by szp*/
#endif
...
/* Prefixes */
    ...
    #define ME_VAPP_PREFIX "/usr/local/lib/goahead/3.4.3"
#endif
    ...
    #define ME_SRC_PREFIX "goahead-3.4.3"
#endif
